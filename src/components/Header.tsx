...
const Header = ({ cursorPointRef }: Props) => {
    ...
    return (
        <header className="header animate-header-animation-loading fixed top-0 left-0 z-50 bg-transparent w-full">
            <main className="header__container absolute top-0 left-0 flex flex-row w-full justify-between items-center gap-16 pt-4 sm:pt-10 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20">
                ...
                <section className="table__and__desktop__view hidden sm:flex flex-1 justify-between items-center w-full">
                    ...
                    <section className="btn__container flex gap-8 xl:text-lg z-20">
                        <div className="flex justify-center items-center w-fit h-fit gap-2 border-2 border-black rounded-full px-2 lg:px-4 py-1 lg:py-2 cursor-pointer"
