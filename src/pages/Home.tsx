    ...
    return (
        <div
            ...
            <div
                        ...
                        <div className="points hidden md:block">
                            <div className="eye animate-eye-animation">
                                <svg width="133" height="130" viewBox="0 0 133 130" fill="none" xmlns="http://www.w3.org/2000/svg" className="-not-active">
                                    ...
                                    <path className={`eye-top transform duration-500 ${mouseCoordinateMove ? "translate-y-5 scale-y-50 opacity-0" : "translate-y-0 scale-y-100 opacity-100"}`} d="M66.4336 49.027C52.5224 49.3515 36.1721 62.6539 36.1721 67.8382C36.1721 73.0225 39.867 61.5001 66.4336 61.5001C93.0002 61.5001 98.3309 73.0224 98.3309 67.8382C98.3309 62.654 80.8912 48.6898 66.4336 49.027Z" fill="#FFEEEE"></path>
                                    <path className={`eye-bottom transform duration-500 ${mouseCoordinateMove ? "translate-y-[45px] scale-y-50 opacity-0" : "translate-y-0 scale-y-100 opacity-100"}`} d="M66.4336 76.0002C42.367 76.0002 36.1721 62.654 36.1721 67.8383C36.1721 73.0226 52.9005 84.442 66.4336 84.7411C80.5277 85.0526 98.3309 73.0225 98.3309 67.8383C98.3309 62.654 90.5002 76.0002 66.4336 76.0002Z" fill="#FFEEEE"></path>
                                    <defs>
                ...
                <div className={`presentation text-center w-full block sm:hidden mt-20 opacity-100 hover:opacity-80 transfrom duration-500 delay-200 ${isPageLoaded ? "opacity-100 translate-y-0 rotate-0" : "opacity-0 translate-y-1/2 rotate-3"}`}>
